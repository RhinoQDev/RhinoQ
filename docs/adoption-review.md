...
| Existing BullMQ worker | preview-first adopter CLI, Integration Eraser scan and leased integration preset with explicit single/fan-out semantics | implemented; code-reduction promise remains unproven |
