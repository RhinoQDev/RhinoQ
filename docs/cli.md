...
The latest verified tagged CLI prerelease is beta.19. Its intended installation
command is:

```bash
go install github.com/madebyduy/RhinoQ/cmd/rhinoq@v0.1.0-beta.19
```

The beta.19 release workflow completed, including signed checksums and prebuilt
