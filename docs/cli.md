...
The latest verified tagged CLI prerelease is beta.28. Its intended installation
command is:

```bash
go install github.com/madebyduy/RhinoQ/cmd/rhinoq@v0.1.0-beta.28
```

The beta.28 release workflow completed, including signed checksums and prebuilt
