...
The latest verified tagged CLI prerelease is beta.13. Its intended installation
command is:

```bash
go install github.com/madebyduy/RhinoQ/cmd/rhinoq@v0.1.0-beta.13
```

The beta.13 release workflow completed, including signed checksums and prebuilt
