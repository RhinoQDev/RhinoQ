...
The latest verified tagged CLI prerelease is beta.18. Its intended installation
command is:

```bash
go install github.com/madebyduy/RhinoQ/cmd/rhinoq@v0.1.0-beta.18
```

The beta.18 release workflow completed, including signed checksums and prebuilt
