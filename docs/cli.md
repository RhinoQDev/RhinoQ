...
The latest verified tagged CLI prerelease is beta.27. Its intended installation
command is:

```bash
go install github.com/madebyduy/RhinoQ/cmd/rhinoq@v0.1.0-beta.27
```

The beta.27 release workflow completed, including signed checksums and prebuilt
