...
The latest verified tagged CLI prerelease is beta.23. Its intended installation
command is:

```bash
go install github.com/madebyduy/RhinoQ/cmd/rhinoq@v0.1.0-beta.23
```

The beta.23 release workflow completed, including signed checksums and prebuilt
