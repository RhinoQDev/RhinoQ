...
The latest verified tagged CLI prerelease is beta.20. Its intended installation
command is:

```bash
go install github.com/madebyduy/RhinoQ/cmd/rhinoq@v0.1.0-beta.20
```

The beta.20 release workflow completed, including signed checksums and prebuilt
