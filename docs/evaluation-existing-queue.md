...
The verified public prerelease is `0.1.0-beta.20`. Pin that version when
...
- installation profile: Task-only schema version 9 (isolated Task tables), or legacy full
  migration 017;
