...
> This portable surface is available in the verified `v0.1.0-beta.14`
...
The Node `init` path creates the isolated Task profile. `beta.14` is the current
...
This package is a development preview. The beta.14 release workflow publishes
...
```bash
npm install /absolute/path/to/rhinoq-node-0.1.0-beta.14.tgz pg
```
