...
async function initReportExportExample(): Promise<void> {
  ...
  const files: Record<string, string> = {
    'package.json': `${JSON.stringify({ name: 'rhinoq-report-export', private: true, type: 'module', scripts: { start: 'node app.mjs' }, dependencies: { '@rhinoq/node': '^0.1.0-beta.14', pg: '^8.22.0' } }, null, 2)}\n`,
