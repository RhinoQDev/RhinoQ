...
export const RHINOQ_CAPABILITY_REGISTRY: readonly RhinoQCapabilityRegistryEntry[] = Object.freeze([
  ...
  { id: 'native-adoption-autopilot', title: 'Native adoption Autopilot', status: 'integrated', evidence: 'technical', owner: 'Node SDK', claim: 'A bounded scan compiles handler, producer, integration-glue, external-effect and cancellation evidence into a fingerprinted plan with shadow and promotion gates.', limit: 'Static evidence cannot choose authentication, stable business identity, idempotency, provider confirmation or business verification.' },
  { id: 'terminal-operations', title: 'Terminal-first Task operations', status: 'implemented', evidence: 'technical', owner: 'Node SDK', claim: 'Watch, inspect and open commands project authoritative Task reads with realtime hints, polling fallback, incident grouping and structured next actions.', limit: 'The terminal is not a production delivery channel; unattended alerts require reviewed durable notification routing.' },
  { id: 'notification-routing', title: 'Severity-aware notification routing', status: 'integrated', evidence: 'technical', owner: 'Go engine', claim: 'Reviewed severity, Rule and subject routes select destinations before the existing event/destination delivery ledger sends and deduplicates a Finding.', limit: 'Routing must be invoked or hosted by the adopter; RhinoQ does not guess paging ownership or escalation policy.' },
