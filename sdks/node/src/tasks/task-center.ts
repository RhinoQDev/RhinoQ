...
:root{color-scheme:light dark;--rq-bg:#f4f5f2;--rq-panel:#fcfdfa;--rq-raised:#fff;--rq-line:#d9ddd7;--rq-ink:#18201d;--rq-muted:#66706b;--rq-accent:#176b55;--rq-accent-soft:#e3f2ec;--rq-warn:#9a6200;--rq-warn-soft:#fff3d6;--rq-bad:#a53b36;--rq-bad-soft:#fbe9e7;--rq-shadow:0 16px 40px rgba(28,42,36,.07)}
@media(prefers-color-scheme:dark){:root{--rq-bg:#111713;--rq-panel:#171e1a;--rq-raised:#1b231f;--rq-line:#303b35;--rq-ink:#eef4f0;--rq-muted:#9eaaa4;--rq-accent:#74d1b4;--rq-accent-soft:#183b30;--rq-warn:#efbd62;--rq-warn-soft:#3b2d14;--rq-bad:#f08b83;--rq-bad-soft:#40221f;--rq-shadow:0 20px 50px rgba(0,0,0,.25)}}
*{box-sizing:border-box}body{margin:0;min-height:100vh;background:var(--rq-bg);color:var(--rq-ink);font:14px/1.55 ui-sans-serif,system-ui,-apple-system,Segoe UI,sans-serif}
.rhinoq-shell{position:sticky;top:0;z-index:20;padding:12px max(20px,calc((100vw - 1120px)/2));background:color-mix(in srgb,var(--rq-bg) 88%,transparent);backdrop-filter:blur(16px);border-color:var(--rq-line)}
.rhinoq-brand{font-size:17px;font-weight:780;letter-spacing:-.035em}.rhinoq-shell nav{align-items:center;padding-left:8px;border-left:1px solid var(--rq-line)}
.rhinoq-shell nav [aria-current="page"]{padding:5px 9px;border-radius:7px;color:var(--rq-accent);background:var(--rq-accent-soft);text-decoration:none}.rhinoq-shell nav a{color:var(--rq-muted)}
[data-rhinoq-task-center]{max-width:1120px;padding:32px 20px 72px;background:transparent;color:var(--rq-ink);font:inherit}
.rhinoq-intro{margin:0 0 24px}.rhinoq-intro>p{margin:0 0 6px;color:var(--rq-accent);font-size:11px;font-weight:760;letter-spacing:.11em;text-transform:uppercase}.rhinoq-intro h1{margin:0;font-size:clamp(28px,4vw,42px);line-height:1.08;letter-spacing:-.05em}.rhinoq-intro>span{display:block;max-width:620px;margin-top:10px;color:var(--rq-muted);font-size:15px}
.rhinoq-tools{grid-template-columns:minmax(16rem,1fr) minmax(9rem,auto) minmax(11rem,auto) auto;gap:10px;margin:0 0 12px;padding:14px;border:1px solid var(--rq-line);border-radius:12px;background:var(--rq-panel);box-shadow:0 1px 0 rgba(20,30,25,.03)}
...
.rhinoq-task-list{gap:10px}.rhinoq-task{grid-template-columns:minmax(0,1fr) auto auto;gap:8px 14px;padding:17px 18px;border-color:var(--rq-line);border-radius:12px;background:var(--rq-panel);box-shadow:0 1px 0 rgba(20,30,25,.03);transition:transform .15s ease,border-color .15s ease,box-shadow .15s ease}
...
.rhinoq-detail-summary{grid-template-columns:minmax(110px,auto) 1fr;gap:8px 24px;margin:18px 0;padding:18px;border:1px solid var(--rq-line);border-radius:12px;background:var(--rq-panel)}.rhinoq-detail-summary strong{color:var(--rq-muted);font-size:11px;letter-spacing:.06em;text-transform:uppercase}
