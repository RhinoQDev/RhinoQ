...
.rhinoq-artifacts{margin-top:24px;padding:18px;border:1px solid var(--rq-line);border-radius:12px;background:var(--rq-panel)}.rhinoq-section-head{display:flex;align-items:flex-end;justify-content:space-between;gap:16px;margin-bottom:14px}.rhinoq-section-head p{margin:0;color:var(--rq-accent);font:700 10px/1.4 var(--rq-mono);letter-spacing:.09em;text-transform:uppercase}.rhinoq-section-head h2{margin:2px 0 0;font-size:19px;letter-spacing:-.025em}.rhinoq-section-head>span{padding:4px 8px;border:1px solid var(--rq-line);border-radius:999px;color:var(--rq-muted);font-size:11px}.rhinoq-artifact-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,300px),1fr));gap:11px}.rhinoq-artifact-card{padding:15px;border:1px solid var(--rq-line);border-radius:10px;background:var(--rq-raised);box-shadow:0 6px 20px rgba(15,35,70,.035)}.rhinoq-artifact-top{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.rhinoq-artifact-name{display:grid;grid-template-columns:auto minmax(0,1fr);align-items:center;gap:9px;min-width:0}.rhinoq-artifact-name>span{display:grid;place-items:center;width:38px;height:38px;border-radius:9px;background:var(--rq-accent-soft);color:var(--rq-accent);font:800 9px/1 var(--rq-mono)}.rhinoq-artifact-name strong{overflow-wrap:anywhere;font-size:14px}.rhinoq-artifact-status{padding:3px 7px;border-radius:999px;font-size:10px;font-weight:750;text-transform:uppercase}.rhinoq-artifact-status.is-available{color:#176b3a;background:#dff7e8}.rhinoq-artifact-status.is-expired{color:var(--rq-warn);background:var(--rq-warn-soft)}.rhinoq-artifact-card dl{display:grid;grid-template-columns:auto minmax(0,1fr);gap:5px 12px;margin:14px 0}.rhinoq-artifact-card dt{color:var(--rq-muted);font-size:11px}.rhinoq-artifact-card dd{margin:0;overflow-wrap:anywhere;text-align:right;font:600 11px/1.5 var(--rq-mono)}.rhinoq-artifact-card button{padding:7px 10px;border:1px solid var(--rq-line);border-radius:7px;background:var(--rq-panel);color:var(--rq-ink);font-weight:650;cursor:pointer}.rhinoq-artifact-card button:first-child{border-color:var(--rq-accent);background:var(--rq-accent);color:#fff}.rhinoq-empty{padding:22px;border:1px dashed var(--rq-line-strong);border-radius:9px;color:var(--rq-muted);text-align:center}
