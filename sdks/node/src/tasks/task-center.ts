...
@media(max-width:600px){.rhinoq-shell{align-items:flex-start;flex-direction:column;gap:.45rem}.rhinoq-task{grid-template-columns:1fr}.rhinoq-task>*{grid-column:1!important}.rhinoq-detail-summary{grid-template-columns:1fr}.rhinoq-detail-summary p{margin-bottom:.5rem}}
`;
